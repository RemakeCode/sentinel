## 2.0.0-beta.4 (2026-08-22)

* fix: align Decky rare achievement toast glow ([1acf913](https://github.com/RemakeCode/sentinel/commit/1acf913))
* fix: consolidate logger sanitization and verify path masking ([ab92c03](https://github.com/RemakeCode/sentinel/commit/ab92c03))
* fix: fix issue with autostart getting disabled after restarts ([9d8a50c](https://github.com/RemakeCode/sentinel/commit/9d8a50c))
* fix: game state tracker race conditions ([c1c1254](https://github.com/RemakeCode/sentinel/commit/c1c1254))
* fix: include missing date in logger timestamps ([c535d03](https://github.com/RemakeCode/sentinel/commit/c535d03))
* fix: issue with missing games causing crashes ([331c91f](https://github.com/RemakeCode/sentinel/commit/331c91f))
* fix: missing menu and taskbar icons ([9c6fc40](https://github.com/RemakeCode/sentinel/commit/9c6fc40))
* fix: resolve issue with notification popups not triggering for cinnamon users ([2f7557e](https://github.com/RemakeCode/sentinel/commit/2f7557e))
* fix: resolve window menu icon on wayland ([25c5c63](https://github.com/RemakeCode/sentinel/commit/25c5c63))
* fix: wait for Deck session before starting watcher ([a1f555a](https://github.com/RemakeCode/sentinel/commit/a1f555a))
* fix(achievements): wrap sort buttons in focusable for better gamepad navigation ([627d5d5](https://github.com/RemakeCode/sentinel/commit/627d5d5))
* fix(achievements): wrap sort buttons in focusable for better gamepad navigation ([82be7b3](https://github.com/RemakeCode/sentinel/commit/82be7b3))
* fix(ci): align release workflows ([55acc8b](https://github.com/RemakeCode/sentinel/commit/55acc8b))
* fix(decky-plugin): bind host timers to fix Illegal invocation ([7463147](https://github.com/RemakeCode/sentinel/commit/7463147))
* fix(decky-plugin): bind host timers to fix Illegal invocation ([cd125a0](https://github.com/RemakeCode/sentinel/commit/cd125a0))
* fix(decky-plugin): make SSE reconnect lifecycle safe ([e867e27](https://github.com/RemakeCode/sentinel/commit/e867e27))
* fix(decky-plugin): show emulator labels ([0a4b386](https://github.com/RemakeCode/sentinel/commit/0a4b386))
* fix(decky): apply SteamGrid artwork on achievement page ([0182cdd](https://github.com/RemakeCode/sentinel/commit/0182cdd))
* fix(decky): establish and maintain SSE connections ([3b37f37](https://github.com/RemakeCode/sentinel/commit/3b37f37))
* fix(decky): fail fast on invalid runtime startup ([f9df568](https://github.com/RemakeCode/sentinel/commit/f9df568))
* fix(decky): refine achievement list navigation layout ([ba2aeef](https://github.com/RemakeCode/sentinel/commit/ba2aeef))
* fix(decky): restore QAM artwork and loading state ([fb13b22](https://github.com/RemakeCode/sentinel/commit/fb13b22))
* fix(decky): sort QAM achievements by unlock time ([ca7bfc8](https://github.com/RemakeCode/sentinel/commit/ca7bfc8))
* fix(decky): start the watcher when users add a prefix for the first time or remove a prefix ([44f28ef](https://github.com/RemakeCode/sentinel/commit/44f28ef))
* ci: build an installable decky-plugin zip ([9188184](https://github.com/RemakeCode/sentinel/commit/9188184))
* ci: build an installable decky-plugin zip ([eef222d](https://github.com/RemakeCode/sentinel/commit/eef222d))
* ci: draft release setup ([90120f8](https://github.com/RemakeCode/sentinel/commit/90120f8))
* ci: linux binary builds in PR ([863d862](https://github.com/RemakeCode/sentinel/commit/863d862))
* ci: zip updates ([e5d110d](https://github.com/RemakeCode/sentinel/commit/e5d110d))
* ci: zip updates ([9fb7535](https://github.com/RemakeCode/sentinel/commit/9fb7535))
* chore/semantic-release-npm (#119) ([cd66567](https://github.com/RemakeCode/sentinel/commit/cd66567)), closes [#119](https://github.com/RemakeCode/sentinel/issues/119)
* origin/sync-main (#104) ([886219e](https://github.com/RemakeCode/sentinel/commit/886219e)), closes [#104](https://github.com/RemakeCode/sentinel/issues/104)
* Promote beta to main (#107) ([ba68523](https://github.com/RemakeCode/sentinel/commit/ba68523)), closes [#107](https://github.com/RemakeCode/sentinel/issues/107)
* Promote beta to main (#70) ([03bb437](https://github.com/RemakeCode/sentinel/commit/03bb437)), closes [#70](https://github.com/RemakeCode/sentinel/issues/70)
* Revert "refactor: consolidate New/NewWithFile duplication in logger" ([6218825](https://github.com/RemakeCode/sentinel/commit/6218825))
* chore: bump dependencies versions for wails3 ([0bdb7da](https://github.com/RemakeCode/sentinel/commit/0bdb7da))
* chore: integrate beta into main promotion ([928a65d](https://github.com/RemakeCode/sentinel/commit/928a65d))
* chore: resolve changelog promotion conflict ([1129013](https://github.com/RemakeCode/sentinel/commit/1129013))
* chore: update icon build paths ([ffe7919](https://github.com/RemakeCode/sentinel/commit/ffe7919))
* chore(decky): additional error handling for cached games ([7572f9b](https://github.com/RemakeCode/sentinel/commit/7572f9b))
* chore(decky): align plugin name ([1bbe4d5](https://github.com/RemakeCode/sentinel/commit/1bbe4d5))
* chore(decky): remove development-only startup settings ([4e486b1](https://github.com/RemakeCode/sentinel/commit/4e486b1))
* chore(decky): styling adjustments ([203ad94](https://github.com/RemakeCode/sentinel/commit/203ad94))
* chore(deps): dependency updates ([96a292c](https://github.com/RemakeCode/sentinel/commit/96a292c))
* chore(release): 2.0.0-beta.2 [skip ci] ([0b8154a](https://github.com/RemakeCode/sentinel/commit/0b8154a))
* chore(release): align semantic-release notes filtering ([bddf656](https://github.com/RemakeCode/sentinel/commit/bddf656))
* chore(release): align semantic-release notes filtering ([4cabc38](https://github.com/RemakeCode/sentinel/commit/4cabc38))
* build: move semantic-release deps to a more predictable setup ([d548bb1](https://github.com/RemakeCode/sentinel/commit/d548bb1))
* build: move semantic-release deps to a more predictable setup ([ab0bb9c](https://github.com/RemakeCode/sentinel/commit/ab0bb9c))
* build(linux): drop obsolete libnotify dependency ([5507c98](https://github.com/RemakeCode/sentinel/commit/5507c98))
* feat: add experimental SteamGridDB artwork support ([6188d27](https://github.com/RemakeCode/sentinel/commit/6188d27))
* feat: centralize rare achievement classification ([59620e3](https://github.com/RemakeCode/sentinel/commit/59620e3))
* feat: use backend rarity in achievement views ([2bd8ccd](https://github.com/RemakeCode/sentinel/commit/2bd8ccd))
* feat(decky-plugin): add decorated Sentinel logger ([922fbed](https://github.com/RemakeCode/sentinel/commit/922fbed))
* feat(decky-plugin): add decorated Sentinel logger ([a86cad4](https://github.com/RemakeCode/sentinel/commit/a86cad4))
* feat(decky): add feedback status for games addition ([5e88715](https://github.com/RemakeCode/sentinel/commit/5e88715))
* feat(decky): add feedback status for games addition ([836ab34](https://github.com/RemakeCode/sentinel/commit/836ab34))
* feat(decky): add feedback status for games addition ([d7949d1](https://github.com/RemakeCode/sentinel/commit/d7949d1))
* docs: game setup for achievements ([28007f2](https://github.com/RemakeCode/sentinel/commit/28007f2))
* docs: game setup for achievements ([ca3da35](https://github.com/RemakeCode/sentinel/commit/ca3da35))

## [2.0.0-beta.3](https://github.com/RemakeCode/sentinel/compare/v2.0.0-beta.2...v2.0.0-beta.3) (2026-07-15)
